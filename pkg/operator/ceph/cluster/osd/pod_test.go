...
func TestPodContainer(t *testing.T) {
	...
	c := cluster.podTemplateSpec([]rookalpha.Device{}, rookalpha.Selection{}, v1.ResourceRequirements{}, cephv1alpha1.StoreConfig{}, "", "")
	assert.NotNil(t, c)
...
func testPodDevices(t *testing.T, dataDir, deviceFilter string, allDevices bool) {
	...
	c := New(&clusterd.Context{Clientset: clientset, ConfigDir: "/var/lib/rook", Executor: &exectest.MockExecutor{}}, "ns", "rook/rook:myversion",
		storageSpec, cephv1alpha1.StoreConfig{}, dataDir, "", rookalpha.Placement{}, false, v1.ResourceRequirements{}, metav1.OwnerReference{})

	devMountNeeded := deviceFilter != "" || allDevices

	n := c.resolveNode(storageSpec.Nodes[0])
	replicaSet := c.makeReplicaSet(n.Name, n.Devices, n.Selection, v1.ResourceRequirements{}, n.StoreConfig, c.metadataDevice, n.Location)
...
func TestStorageSpecDevicesAndDirectories(t *testing.T) {
	...
	clientset := fake.NewSimpleClientset()
	c := New(&clusterd.Context{Clientset: clientset, ConfigDir: "/var/lib/rook", Executor: &exectest.MockExecutor{}}, "ns", "rook/rook:myversion",
		storageSpec, cephv1alpha1.StoreConfig{}, "", "", rookalpha.Placement{}, false, v1.ResourceRequirements{}, metav1.OwnerReference{})
...
func TestStorageSpecConfig(t *testing.T) {
	...
	n := c.resolveNode(storageSpec.Nodes[0])
	replicaSet := c.makeReplicaSet(n.Name, n.Devices, n.Selection, c.Storage.Nodes[0].Resources, n.StoreConfig, c.metadataDevice, n.Location)
	assert.NotNil(t, replicaSet)
	...
	assert.Equal(t, n.StoreConfig, cfg)
}
...
func TestHostNetwork(t *testing.T) {
	...
	c := New(&clusterd.Context{Clientset: clientset, ConfigDir: "/var/lib/rook", Executor: &exectest.MockExecutor{}}, "ns", "myversion",
		storageSpec, cephv1alpha1.StoreConfig{}, "", "", rookalpha.Placement{}, true, v1.ResourceRequirements{}, metav1.OwnerReference{})

	n := c.resolveNode(storageSpec.Nodes[0])
	r := c.makeReplicaSet(n.Name, n.Devices, n.Selection, v1.ResourceRequirements{}, n.StoreConfig, c.metadataDevice, n.Location)
	assert.NotNil(t, r)
