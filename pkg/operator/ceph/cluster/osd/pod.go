...
func (c *Cluster) makeDaemonSet(selection rookalpha.Selection, storeConfig cephv1alpha1.StoreConfig, metadataDevice, location string) *extensions.DaemonSet {
...
func (c *Cluster) makeReplicaSet(nodeName string, devices []rookalpha.Device, selection rookalpha.Selection, resources v1.ResourceRequirements,
	storeConfig cephv1alpha1.StoreConfig, metadataDevice, location string) *extensions.ReplicaSet {
...
func (c *Cluster) podTemplateSpec(devices []rookalpha.Device, selection rookalpha.Selection, resources v1.ResourceRequirements,
	storeConfig cephv1alpha1.StoreConfig, metadataDevice, location string) v1.PodTemplateSpec {
...
func (c *Cluster) osdContainer(devices []rookalpha.Device, selection rookalpha.Selection, resources v1.ResourceRequirements,
	storeConfig cephv1alpha1.StoreConfig, metadataDevice, location string) v1.Container {
...
func getStoreConfigFromContainer(osdContainer v1.Container) cephv1alpha1.StoreConfig {
	cfg := cephv1alpha1.StoreConfig{}
