...
func New(context *clusterd.Context, namespace, version string, storageSpec rookalpha.StorageScopeSpec, storeConfig cephv1alpha1.StoreConfig,
	dataDirHostPath string, metadataDevice string, placement rookalpha.Placement, hostNetwork bool,
...
func (c *Cluster) Start() error {
	...
	if c.Storage.UseAllNodes {
		...
		ds := c.makeDaemonSet(c.Storage.Selection, c.StoreConfig, c.metadataDevice, c.Storage.Location)
	...
	for i := range c.Storage.Nodes {
		...
		rs := c.makeReplicaSet(n.Name, n.Devices, n.Selection, n.Resources, n.StoreConfig, c.metadataDevice, n.Location)
	...
	for i := range removedNodes {
		...
		rs := c.makeReplicaSet(n.Name, nil, rookalpha.Selection{DeviceFilter: "none", Directories: n.Directories},
			v1.ResourceRequirements{}, cephv1alpha1.StoreConfig{}, "", "")
...
func (c *Cluster) handleOrchestrationFailure(n cephv1alpha1.Node, message string, errorMessages *[]string) {
...
func (c *Cluster) findRemovedNodes() ([]cephv1alpha1.Node, error) {
	var removedNodes []cephv1alpha1.Node
...
func (c *Cluster) discoverStorageNodes() ([]cephv1alpha1.Node, error) {
	var discoveredNodes []cephv1alpha1.Node
	...
	discoveredNodes = make([]cephv1alpha1.Node, len(osdReplicaSets.Items))
	for i, osdReplicaSet := range osdReplicaSets.Items {
		...
		node := cephv1alpha1.Node{
			...
			StoreConfig: getStoreConfigFromContainer(osdContainer),
		}
...
func (c *Cluster) isSafeToRemoveNode(node cephv1alpha1.Node) error {
...
func (c *Cluster) getOSDsForNode(node cephv1alpha1.Node) ([]int, error) {
...
func (c *Cluster) resolveNode(storageNode rookalpha.Node) *cephv1alpha1.Node {
	// fully resolve the storage config and resources for this node
	...
	storeConfig := cephv1alpha1.ResolveConfig(rookNode.Config)
